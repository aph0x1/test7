...
(function() {
  ...
  cervezaCommand = (function(_super) {
    ...
    cervezaCommand.prototype.getcerveza = function() {
      var c, cervezas;
      cervezas = [" una cerveza bien fria!!!","una cerveza"];
    ...
    cervezaCommand.prototype.functionality = function() {
      ...
      if (msg.length > 8) {
        ...
        if (user === false) {
          ...
          return API.sendChat("@" + user.username + ", @" + this.msgData.from + " te ha dado " + this.getcerveza() + ". Disfrutala!.");
        }
      }
    };
  ...
  tableFlipCommand = (function(_super) {
    ...
    tableFlipCommand.prototype.functionality = function() {
      return API.sendChat("(â•¯Â°â–¡Â°ï¼‰â•¯ï¸µ â”»â”â”»");
    };
  ...
  tableFixCommand = (function(_super) {
    ...
    tableFixCommand.prototype.functionality = function() {
      return API.sendChat(" â”¬â”€â”¬ãƒŽ( Âº _ ÂºãƒŽ)");
    };
